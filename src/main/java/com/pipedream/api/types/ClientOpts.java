...
@JsonDeserialize(builder = ClientOpts.Builder.class)
public final class ClientOpts {
    ...
    /**
     * @return The API URL to use (defaults to https://api.pipedream.com/)
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientOpts && equalTo((ClientOpts) other);
    }
    ...
    private boolean equalTo(ClientOpts other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ClientOpts other) {
        ...
        /**
         * <p>The API URL to use (defaults to https://api.pipedream.com/)</p>
         */
        ...
        public ClientOpts build() {
            return new ClientOpts(clientId, clientSecret, apiUrl, additionalProperties);
        }
