...
public final class ConfigurablePropInteger {
    ...
    private Optional<List<ConfigurablePropIntegerOptionsItem>> _getOptions() {
        return options;
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage options(Nullable<List<ConfigurablePropIntegerOptionsItem>> options);
    ...
    public static final class Builder implements NameStage, _FinalStage {
         ...
         */
        @java.lang.Override
        public _FinalStage options(Nullable<List<ConfigurablePropIntegerOptionsItem>> options) {
            if (options.isNull()) {
                this.options = null;
