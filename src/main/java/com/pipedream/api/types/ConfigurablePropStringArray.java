...
public final class ConfigurablePropStringArray {
    ...
    private Optional<List<String>> _getDefault() {
        return default_;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConfigurablePropStringArray && equalTo((ConfigurablePropStringArray) other);
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage default_(Nullable<List<String>> default_);
    ...
    public static final class Builder implements NameStage, _FinalStage {
         ...
         */
        @java.lang.Override
        public _FinalStage default_(Nullable<List<String>> default_) {
            if (default_.isNull()) {
                this.default_ = null;
