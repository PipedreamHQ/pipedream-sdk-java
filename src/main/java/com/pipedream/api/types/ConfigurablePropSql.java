...
public final class ConfigurablePropSql {
    ...
    @JsonProperty("auth")
    private Optional<ConfigurablePropSqlAuth> _getAuth() {
        return auth;
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage auth(Nullable<ConfigurablePropSqlAuth> auth);
    ...
    public static final class Builder implements NameStage, _FinalStage {
        ...
        @java.lang.Override
        public _FinalStage auth(Nullable<ConfigurablePropSqlAuth> auth) {
            if (auth.isNull()) {
                this.auth = null;
