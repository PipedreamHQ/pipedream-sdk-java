...
@JsonDeserialize(builder = GetAppsResponse.Builder.class)
public final class GetAppsResponse {
    ...
    private GetAppsResponse(List<App> data, PageInfo pageInfo, Map<String, Object> additionalProperties) {
        this.data = data;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetAppsResponse && equalTo((GetAppsResponse) other);
    }
    ...
    private boolean equalTo(GetAppsResponse other) {
    ...
    public interface PageInfoStage {
        ...
        Builder from(GetAppsResponse other);
    }

    public interface _FinalStage {
        GetAppsResponse build();
    ...
    public static final class Builder implements PageInfoStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(GetAppsResponse other) {
            data(other.getData());
        ...
        public GetAppsResponse build() {
            return new GetAppsResponse(data, pageInfo, additionalProperties);
        }
    }
}
