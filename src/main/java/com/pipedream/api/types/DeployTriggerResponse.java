...
public final class DeployTriggerResponse {
    private final DeployTriggerResponseData data;

    private final Map<String, Object> additionalProperties;

    private DeployTriggerResponse(DeployTriggerResponseData data, Map<String, Object> additionalProperties) {
        this.data = data;
        this.additionalProperties = additionalProperties;
    }

    @JsonProperty("data")
    public DeployTriggerResponseData getData() {
        return data;
    }
    ...
    public interface DataStage {
        _FinalStage data(@NotNull DeployTriggerResponseData data);
    ...
    public static final class Builder implements DataStage, _FinalStage {
        private DeployTriggerResponseData data;
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(@NotNull DeployTriggerResponseData data) {
