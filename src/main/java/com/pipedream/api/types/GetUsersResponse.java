...
public final class GetUsersResponse {
    private final List<ExternalUser> data;

    private final PageInfo pageInfo;

    private final Map<String, Object> additionalProperties;

    private GetUsersResponse(List<ExternalUser> data, PageInfo pageInfo, Map<String, Object> additionalProperties) {
        this.data = data;
    ...
    @JsonProperty("data")
    public List<ExternalUser> getData() {
        return data;
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage addAllData(List<ExternalUser> data);
    }
    ...
    public static final class Builder implements PageInfoStage, _FinalStage {
        ...
        private List<ExternalUser> data = new ArrayList<>();
        ...
        @java.lang.Override
        public _FinalStage addAllData(List<ExternalUser> data) {
            if (data != null) {
        ...
        @java.lang.Override
        public _FinalStage addData(ExternalUser data) {
            this.data.add(data);
            return this;
        }
        ...
        public _FinalStage data(List<ExternalUser> data) {
            this.data.clear();
            if (data != null) {
                this.data.addAll(data);
            }
