...
public final class ConfigurePropResponse {
    private final Optional<List<ConfigurePropOptionItem>> options;
    ...
    private ConfigurePropResponse(
            Optional<List<ConfigurePropOptionItem>> options,
    ...
    public Optional<List<ConfigurePropOptionItem>> getOptions() {
        return options;
    }
    ...
    public static final class Builder {
        private Optional<List<ConfigurePropOptionItem>> options = Optional.empty();
        ...
        public Builder options(Optional<List<ConfigurePropOptionItem>> options) {
            this.options = options;
            return this;
        }

        public Builder options(List<ConfigurePropOptionItem> options) {
