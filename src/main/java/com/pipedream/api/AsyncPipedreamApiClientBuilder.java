...
public final class AsyncPipedreamApiClientBuilder {
     ...
     * Sets xPdEnvironment
     */
    public AsyncPipedreamApiClientBuilder xPdEnvironment(String xPdEnvironment) {
    ...
    public AsyncPipedreamApiClient build() {
        ...
        if (xPdEnvironment != null) {
            this.clientOptionsBuilder.addHeader("x-pd-environment", this.xPdEnvironment);
        }
