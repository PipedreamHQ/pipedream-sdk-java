...
public class RawWebhooksClient {
     ...
     */
    public BaseClientHttpResponse<GetWebhookResponse> retrieve() {
     ...
     * Retrieve the webhook configured for a project environment
     */
    public BaseClientHttpResponse<GetWebhookResponse> retrieve(RequestOptions requestOptions) {
     ...
     */
    public BaseClientHttpResponse<SetWebhookResponse> update(SetWebhookOpts request) {
     ...
     * Create or update the webhook URL for a project environment. Creating a webhook returns <code>signing_key</code>; updating an existing webhook does not.
     */
    public BaseClientHttpResponse<SetWebhookResponse> update(SetWebhookOpts request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("v1/connect")
                .addPathSegment(clientOptions.projectId())
     ...
     * Remove the webhook configured for a project environment
     */
    public BaseClientHttpResponse<Void> delete(RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("v1/connect")
                .addPathSegment(clientOptions.projectId())
