...
public class RawActionsClient {
    ...
    public PipedreamClientHttpResponse<SyncPagingIterable<Component>> list(ActionsListRequest request) {
    ...
    public PipedreamClientHttpResponse<ConfigurePropResponse> configureProp(ActionsConfigurePropRequest request) {
    ...
    public PipedreamClientHttpResponse<ReloadPropsResponse> reloadProps(ActionsReloadPropsRequest request) {
    ...
    public PipedreamClientHttpResponse<RunActionResponse> run(RunActionOpts request) {
        return run(request, null);
    }

    public PipedreamClientHttpResponse<RunActionResponse> run(RunActionOpts request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("v1/connect")
                .addPathSegment(clientOptions.projectId())
