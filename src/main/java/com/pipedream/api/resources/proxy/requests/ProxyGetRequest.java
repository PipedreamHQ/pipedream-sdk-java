...
@JsonDeserialize(builder = ProxyGetRequest.Builder.class)
public final class ProxyGetRequest {
    ...
    private ProxyGetRequest(String externalUserId, String accountId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ProxyGetRequest && equalTo((ProxyGetRequest) other);
    }
    ...
    private boolean equalTo(ProxyGetRequest other) {
    ...
    public interface ExternalUserIdStage {
        ...
        Builder from(ProxyGetRequest other);
    }
    ...
    public static final class Builder implements ExternalUserIdStage, AccountIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ProxyGetRequest other) {
