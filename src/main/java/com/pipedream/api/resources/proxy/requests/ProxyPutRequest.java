...
@JsonDeserialize(builder = ProxyPutRequest.Builder.class)
public final class ProxyPutRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ProxyPutRequest && equalTo((ProxyPutRequest) other);
    }
    ...
    private boolean equalTo(ProxyPutRequest other) {
    ...
    public interface ExternalUserIdStage {
        ...
        Builder from(ProxyPutRequest other);
    }
    ...
    public static final class Builder implements ExternalUserIdStage, AccountIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ProxyPutRequest other) {
