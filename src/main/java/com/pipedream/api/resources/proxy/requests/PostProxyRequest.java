...
@JsonDeserialize(builder = PostProxyRequest.Builder.class)
public final class PostProxyRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PostProxyRequest && equalTo((PostProxyRequest) other);
    }
    ...
    private boolean equalTo(PostProxyRequest other) {
    ...
    public interface ExternalUserIdStage {
        ...
        Builder from(PostProxyRequest other);
    }
    ...
    public static final class Builder implements ExternalUserIdStage, AccountIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(PostProxyRequest other) {
        ...
        @java.lang.Override
        public PostProxyRequest build() {
            return new PostProxyRequest(externalUserId, accountId, body, additionalProperties);
        }
    }
}
