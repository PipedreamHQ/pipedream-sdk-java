...
@JsonDeserialize(builder = GetProxyRequest.Builder.class)
public final class GetProxyRequest {
    ...
    private GetProxyRequest(String externalUserId, String accountId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetProxyRequest && equalTo((GetProxyRequest) other);
    }
    ...
    private boolean equalTo(GetProxyRequest other) {
    ...
    public interface ExternalUserIdStage {
        ...
        Builder from(GetProxyRequest other);
    }
    ...
    public static final class Builder implements ExternalUserIdStage, AccountIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(GetProxyRequest other) {
        ...
        public GetProxyRequest build() {
            return new GetProxyRequest(externalUserId, accountId, additionalProperties);
        }
    }
}
