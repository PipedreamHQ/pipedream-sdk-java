...
@JsonDeserialize(builder = PutProxyRequest.Builder.class)
public final class PutProxyRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PutProxyRequest && equalTo((PutProxyRequest) other);
    }
    ...
    private boolean equalTo(PutProxyRequest other) {
    ...
    public interface ExternalUserIdStage {
        ...
        Builder from(PutProxyRequest other);
    }
    ...
    public static final class Builder implements ExternalUserIdStage, AccountIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(PutProxyRequest other) {
        ...
        @java.lang.Override
        public PutProxyRequest build() {
            return new PutProxyRequest(externalUserId, accountId, body, additionalProperties);
        }
    }
}
