...
@JsonDeserialize(builder = ProxyPatchRequest.Builder.class)
public final class ProxyPatchRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ProxyPatchRequest && equalTo((ProxyPatchRequest) other);
    }
    ...
    private boolean equalTo(ProxyPatchRequest other) {
    ...
    public static final class Builder implements ExternalUserIdStage, AccountIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ProxyPatchRequest other) {
