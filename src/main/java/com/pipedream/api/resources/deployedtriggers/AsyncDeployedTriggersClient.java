...
public class AsyncDeployedTriggersClient {
     ...
     */
    public CompletableFuture<GetWebhookWithSigningKeyResponse> retrieveWebhooks(
            String triggerId, String webhookId, DeployedTriggersRetrieveWebhooksRequest request) {
        return this.rawClient.retrieveWebhooks(triggerId, webhookId, request).thenApply(response -> response.body());
    }
