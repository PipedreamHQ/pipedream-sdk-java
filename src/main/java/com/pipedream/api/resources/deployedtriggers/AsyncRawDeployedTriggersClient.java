...
public class AsyncRawDeployedTriggersClient {
     ...
     */
    public CompletableFuture<BaseClientHttpResponse<UpdateTriggerWebhooksResponse>> updateWebhooks(
    ...
    public CompletableFuture<BaseClientHttpResponse<UpdateTriggerWebhooksResponse>> updateWebhooks(
        ...
        CompletableFuture<BaseClientHttpResponse<UpdateTriggerWebhooksResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new BaseClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBody.string(), UpdateTriggerWebhooksResponse.class),
                                response));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
     ...
     */
    public CompletableFuture<BaseClientHttpResponse<GetWebhookWithSigningKeyResponse>> retrieveWebhooks(
            String triggerId, String webhookId, DeployedTriggersRetrieveWebhooksRequest request) {
        return retrieveWebhooks(triggerId, webhookId, request, null);
    }
