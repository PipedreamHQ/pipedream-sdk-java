...
@JsonDeserialize(builder = RetrieveDeployedTriggersRequest.Builder.class)
public final class RetrieveDeployedTriggersRequest {
    private final String externalUserId;

    private final Map<String, Object> additionalProperties;

    private RetrieveDeployedTriggersRequest(String externalUserId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof RetrieveDeployedTriggersRequest && equalTo((RetrieveDeployedTriggersRequest) other);
    }
    ...
    private boolean equalTo(RetrieveDeployedTriggersRequest other) {
    ...
    public interface ExternalUserIdStage {
        ...
        Builder from(RetrieveDeployedTriggersRequest other);
    }

    public interface _FinalStage {
        RetrieveDeployedTriggersRequest build();
    }
    ...
    public static final class Builder implements ExternalUserIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(RetrieveDeployedTriggersRequest other) {
        ...
        @java.lang.Override
        public RetrieveDeployedTriggersRequest build() {
            return new RetrieveDeployedTriggersRequest(externalUserId, additionalProperties);
        }
    }
}
