...
@JsonDeserialize(builder = DeployedTriggersRegenerateWebhookSigningKeyRequest.Builder.class)
public final class DeployedTriggersRegenerateWebhookSigningKeyRequest {
    private final String externalUserId;

    private final Map<String, Object> additionalProperties;

    private DeployedTriggersRegenerateWebhookSigningKeyRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DeployedTriggersRegenerateWebhookSigningKeyRequest
                && equalTo((DeployedTriggersRegenerateWebhookSigningKeyRequest) other);
    }
    ...
    private boolean equalTo(DeployedTriggersRegenerateWebhookSigningKeyRequest other) {
    ...
    public interface ExternalUserIdStage {
        ...
        Builder from(DeployedTriggersRegenerateWebhookSigningKeyRequest other);
    }
    ...
    public static final class Builder implements ExternalUserIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(DeployedTriggersRegenerateWebhookSigningKeyRequest other) {
