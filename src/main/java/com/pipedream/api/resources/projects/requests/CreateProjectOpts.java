...
public final class CreateProjectOpts {
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.name, this.appName, this.supportEmail, this.externalUrl);
    }
    ...
    public static final class Builder implements NameStage, _FinalStage {
        ...
        public CreateProjectOpts build() {
            return new CreateProjectOpts(name, appName, supportEmail, externalUrl, additionalProperties);
        }
    }
}
