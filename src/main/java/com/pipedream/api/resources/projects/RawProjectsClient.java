...
public class RawProjectsClient {
     ...
     * Get the project details for a specific project
     */
    public BaseClientHttpResponse<Project> retrieve(RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("v1/connect/projects")
     ...
     * Update project details or application information
     */
    public BaseClientHttpResponse<Project> update(UpdateProjectOpts request) {
     ...
     * Update project details or application information
     */
    public BaseClientHttpResponse<Project> update(UpdateProjectOpts request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("v1/connect/projects")
                .addPathSegment(clientOptions.projectId())
     ...
     */
    public BaseClientHttpResponse<Void> updateLogo(UpdateProjectLogoOpts request) {
     ...
     * Upload or replace the project logo
     */
    public BaseClientHttpResponse<Void> updateLogo(UpdateProjectLogoOpts request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("v1/connect/projects")
                .addPathSegment(clientOptions.projectId())
