...
public class AsyncRawAppsClient {
    ...
    public CompletableFuture<PipedreamClientHttpResponse<SyncPagingIterable<App>>> list() {
        return list(AppsListRequest.builder().build());
    }

    public CompletableFuture<PipedreamClientHttpResponse<SyncPagingIterable<App>>> list(AppsListRequest request) {
    ...
    public CompletableFuture<PipedreamClientHttpResponse<SyncPagingIterable<App>>> list(
        ...
        CompletableFuture<PipedreamClientHttpResponse<SyncPagingIterable<App>>> future = new CompletableFuture<>();
    ...
    public CompletableFuture<PipedreamClientHttpResponse<GetAppResponse>> retrieve(String appId) {
        return retrieve(appId, null);
    }

    public CompletableFuture<PipedreamClientHttpResponse<GetAppResponse>> retrieve(
        ...
        CompletableFuture<PipedreamClientHttpResponse<GetAppResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
