...
import com.pipedream.api.resources.apps.types.ListAppsRequestSortDirection;
import com.pipedream.api.resources.apps.types.ListAppsRequestSortKey;
...
public final class ListAppsRequest {
    ...
    private final Optional<ListAppsRequestSortKey> sortKey;

    private final Optional<ListAppsRequestSortDirection> sortDirection;
    ...
    private ListAppsRequest(
            ...
            Optional<String> q,
            Optional<ListAppsRequestSortKey> sortKey,
            Optional<ListAppsRequestSortDirection> sortDirection,
    ...
    public Optional<ListAppsRequestSortKey> getSortKey() {
        return sortKey;
    }
    ...
    public Optional<ListAppsRequestSortDirection> getSortDirection() {
    ...
    public static final class Builder {
        ...
        private Optional<ListAppsRequestSortKey> sortKey = Optional.empty();

        private Optional<ListAppsRequestSortDirection> sortDirection = Optional.empty();
        ...
        public Builder sortKey(Optional<ListAppsRequestSortKey> sortKey) {
            this.sortKey = sortKey;
            return this;
        }

        public Builder sortKey(ListAppsRequestSortKey sortKey) {
        ...
        public Builder sortDirection(Optional<ListAppsRequestSortDirection> sortDirection) {
            this.sortDirection = sortDirection;
            return this;
        }

        public Builder sortDirection(ListAppsRequestSortDirection sortDirection) {
