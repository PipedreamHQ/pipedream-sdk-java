...
import com.pipedream.api.resources.triggers.types.ListTriggersRequestRegistry;
...
@JsonDeserialize(builder = ListTriggersRequest.Builder.class)
public final class ListTriggersRequest {
    ...
    private final Optional<ListTriggersRequestRegistry> registry;
    ...
    private ListTriggersRequest(
            ...
            Optional<String> q,
            Optional<String> app,
            Optional<ListTriggersRequestRegistry> registry,
    ...
    public Optional<ListTriggersRequestRegistry> getRegistry() {
        return registry;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListTriggersRequest && equalTo((ListTriggersRequest) other);
    }
    ...
    private boolean equalTo(ListTriggersRequest other) {
    ...
    public static final class Builder {
        ...
        private Optional<ListTriggersRequestRegistry> registry = Optional.empty();
        ...
        public Builder from(ListTriggersRequest other) {
        ...
        public Builder registry(Optional<ListTriggersRequestRegistry> registry) {
            this.registry = registry;
            return this;
        }

        public Builder registry(ListTriggersRequestRegistry registry) {
            this.registry = Optional.ofNullable(registry);
            return this;
        }

        public ListTriggersRequest build() {
            return new ListTriggersRequest(after, before, limit, q, app, registry, additionalProperties);
        }
    }
}
