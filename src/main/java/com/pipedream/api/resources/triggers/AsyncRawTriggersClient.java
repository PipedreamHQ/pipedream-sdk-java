...
public class AsyncRawTriggersClient {
    ...
    public CompletableFuture<PipedreamApiClientHttpResponse<SyncPagingIterable<Component>>> list() {
    ...
    public CompletableFuture<PipedreamApiClientHttpResponse<SyncPagingIterable<Component>>> list(
        ...
        CompletableFuture<PipedreamApiClientHttpResponse<SyncPagingIterable<Component>>> future =
    ...
    public CompletableFuture<PipedreamApiClientHttpResponse<Component>> retrieve(String componentId) {
        return retrieve(componentId, null);
    }

    public CompletableFuture<PipedreamApiClientHttpResponse<Component>> retrieve(
        ...
        CompletableFuture<PipedreamApiClientHttpResponse<Component>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<PipedreamApiClientHttpResponse<ConfigurePropResponse>> configureProp(
    ...
    public CompletableFuture<PipedreamApiClientHttpResponse<ConfigurePropResponse>> configureProp(
        ...
        CompletableFuture<PipedreamApiClientHttpResponse<ConfigurePropResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<PipedreamApiClientHttpResponse<ReloadPropsResponse>> reloadProps(
    ...
    public CompletableFuture<PipedreamApiClientHttpResponse<ReloadPropsResponse>> reloadProps(
        ...
        CompletableFuture<PipedreamApiClientHttpResponse<ReloadPropsResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<PipedreamApiClientHttpResponse<DeployedComponent>> deploy(DeployTriggerOpts request) {
        return deploy(request, null);
    }

    public CompletableFuture<PipedreamApiClientHttpResponse<DeployedComponent>> deploy(
