...
public class AsyncRawUsersClient {
    ...
    public CompletableFuture<PipedreamApiClientHttpResponse<Void>> deleteExternalUser(String externalUserId) {
        return deleteExternalUser(externalUserId, null);
    }

    public CompletableFuture<PipedreamApiClientHttpResponse<Void>> deleteExternalUser(
