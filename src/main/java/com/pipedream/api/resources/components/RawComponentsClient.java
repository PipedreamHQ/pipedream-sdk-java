...
public class RawComponentsClient {
    ...
    public PipedreamClientHttpResponse<SyncPagingIterable<Component>> list(ComponentsListRequest request) {
    ...
    public PipedreamClientHttpResponse<ConfigurePropResponse> configureProp(ComponentsConfigurePropRequest request) {
    ...
    public PipedreamClientHttpResponse<ReloadPropsResponse> reloadProps(ComponentsReloadPropsRequest request) {
