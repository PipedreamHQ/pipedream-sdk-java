...
public class RawWorkflowsClient {
    ...
    public BaseClientHttpResponse<Object> invoke(InvokeWorkflowOpts request) {
        return invoke(request, null);
    }

    public BaseClientHttpResponse<Object> invoke(InvokeWorkflowOpts request, RequestOptions requestOptions) {
    ...
    public BaseClientHttpResponse<Object> invokeForExternalUser(InvokeWorkflowForExternalUserOpts request) {
        return invokeForExternalUser(request, null);
    }

    public BaseClientHttpResponse<Object> invokeForExternalUser(
        ...
        if (request.getUrl() == null || request.getUrl().trim().isEmpty()) {
            throw new IllegalArgumentException("Workflow URL is required");
        }
