...
public class RawAppCategoriesClient {
    protected final ClientOptions clientOptions;

    public RawAppCategoriesClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public PipedreamApiClientHttpResponse<List<AppCategory>> list() {
        return list(null);
    }

    public PipedreamApiClientHttpResponse<List<AppCategory>> list(RequestOptions requestOptions) {
    ...
    public PipedreamApiClientHttpResponse<AppCategory> retrieve(String id) {
        return retrieve(id, null);
    }

    public PipedreamApiClientHttpResponse<AppCategory> retrieve(String id, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("v1/connect/app_categories")
                .addPathSegment(id)
