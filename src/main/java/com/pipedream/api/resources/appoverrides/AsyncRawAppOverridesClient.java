...
public class AsyncRawAppOverridesClient {
    protected final ClientOptions clientOptions;

    public AsyncRawAppOverridesClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<BaseClientHttpResponse<SyncPagingIterable<AppOverride>>> list() {
     ...
     */
    public CompletableFuture<BaseClientHttpResponse<SyncPagingIterable<AppOverride>>> list(
            AppOverridesListRequest request) {
    ...
    public CompletableFuture<BaseClientHttpResponse<SyncPagingIterable<AppOverride>>> list(
        ...
        CompletableFuture<BaseClientHttpResponse<SyncPagingIterable<AppOverride>>> future = new CompletableFuture<>();
     ...
     */
    public CompletableFuture<BaseClientHttpResponse<AppOverride>> create(CreateAppOverrideOpts request) {
     ...
     * Create an app override with pre-defined custom field values
     */
    public CompletableFuture<BaseClientHttpResponse<AppOverride>> create(
            CreateAppOverrideOpts request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("v1/connect")
                .addPathSegment(clientOptions.projectId())
        ...
        CompletableFuture<BaseClientHttpResponse<AppOverride>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<BaseClientHttpResponse<AppOverride>> retrieve(String id) {
     ...
     * Get the configuration of a specific app override
     */
    public CompletableFuture<BaseClientHttpResponse<AppOverride>> retrieve(String id, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("v1/connect")
                .addPathSegment(clientOptions.projectId())
     ...
     */
    public CompletableFuture<BaseClientHttpResponse<AppOverride>> update(String id) {
     ...
     * Update an app override's name, custom field values, or OAuth client selection
     */
    public CompletableFuture<BaseClientHttpResponse<AppOverride>> update(String id, RequestOptions requestOptions) {
     ...
     * Update an app override's name, custom field values, or OAuth client selection
     */
    public CompletableFuture<BaseClientHttpResponse<AppOverride>> update(String id, UpdateAppOverrideOpts request) {
     ...
     * Update an app override's name, custom field values, or OAuth client selection
     */
    public CompletableFuture<BaseClientHttpResponse<AppOverride>> update(
