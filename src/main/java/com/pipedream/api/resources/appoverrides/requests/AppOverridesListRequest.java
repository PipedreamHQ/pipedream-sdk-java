...
@JsonDeserialize(builder = AppOverridesListRequest.Builder.class)
public final class AppOverridesListRequest {
    ...
    private AppOverridesListRequest(
    ...
    /**
     * @return Only return overrides for this app (ID or name slug)
     */
    @JsonProperty("app")
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AppOverridesListRequest && equalTo((AppOverridesListRequest) other);
    }
    ...
    private boolean equalTo(AppOverridesListRequest other) {
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.after, this.before, this.limit, this.app);
    }
    ...
    public static final class Builder {
        ...
        public Builder from(AppOverridesListRequest other) {
        ...
        /**
         * <p>Only return overrides for this app (ID or name slug)</p>
         */
        ...
        public AppOverridesListRequest build() {
            return new AppOverridesListRequest(after, before, limit, app, additionalProperties);
        }
