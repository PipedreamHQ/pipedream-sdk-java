...
@JsonDeserialize(builder = ValidateTokensRequest.Builder.class)
public final class ValidateTokensRequest {
    ...
    private ValidateTokensRequest(String appId, Optional<String> oauthAppId, Map<String, Object> additionalProperties) {
        this.appId = appId;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ValidateTokensRequest && equalTo((ValidateTokensRequest) other);
    }
    ...
    private boolean equalTo(ValidateTokensRequest other) {
    ...
    public interface AppIdStage {
        ...
        Builder from(ValidateTokensRequest other);
    }

    public interface _FinalStage {
        ValidateTokensRequest build();
    ...
    public static final class Builder implements AppIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ValidateTokensRequest other) {
        ...
        @java.lang.Override
        public ValidateTokensRequest build() {
            return new ValidateTokensRequest(appId, oauthAppId, additionalProperties);
        }
    }
}
