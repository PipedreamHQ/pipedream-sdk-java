...
public class AsyncRawOauthTokensClient {
    protected final ClientOptions clientOptions;

    public AsyncRawOauthTokensClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public CompletableFuture<PipedreamClientHttpResponse<CreateOAuthTokenResponse>> create(
    ...
    public CompletableFuture<PipedreamClientHttpResponse<CreateOAuthTokenResponse>> create(
        ...
        CompletableFuture<PipedreamClientHttpResponse<CreateOAuthTokenResponse>> future = new CompletableFuture<>();
