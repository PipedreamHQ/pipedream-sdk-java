...
public class RawTokensClient {
    ...
    public PipedreamApiClientHttpResponse<CreateTokenResponse> create(CreateTokenRequest request) {
        return create(request, null);
    }

    public PipedreamApiClientHttpResponse<CreateTokenResponse> create(
    ...
    public PipedreamApiClientHttpResponse<ValidateTokenResponse> validate(String ctok) {
        return validate(ctok, TokensValidateRequest.builder().build());
    }

    public PipedreamApiClientHttpResponse<ValidateTokenResponse> validate(String ctok, TokensValidateRequest request) {
        return validate(ctok, request, null);
    }

    public PipedreamApiClientHttpResponse<ValidateTokenResponse> validate(
