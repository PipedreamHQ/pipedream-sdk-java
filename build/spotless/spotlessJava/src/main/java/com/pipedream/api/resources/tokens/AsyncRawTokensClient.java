...
public class AsyncRawTokensClient {
    ...
    public CompletableFuture<PipedreamClientHttpResponse<CreateTokenResponse>> create(CreateTokenRequest request) {
        return create(request, null);
    }

    public CompletableFuture<PipedreamClientHttpResponse<CreateTokenResponse>> create(
        ...
        CompletableFuture<PipedreamClientHttpResponse<CreateTokenResponse>> future = new CompletableFuture<>();
    ...
    public CompletableFuture<PipedreamClientHttpResponse<ValidateTokenResponse>> validate(String ctok) {
        return validate(ctok, TokensValidateRequest.builder().build());
    }

    public CompletableFuture<PipedreamClientHttpResponse<ValidateTokenResponse>> validate(
    ...
    public CompletableFuture<PipedreamClientHttpResponse<ValidateTokenResponse>> validate(
        ...
        CompletableFuture<PipedreamClientHttpResponse<ValidateTokenResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
