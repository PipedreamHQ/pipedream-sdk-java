...
public class AsyncRawTokensClient {
    ...
    public CompletableFuture<PipedreamApiClientHttpResponse<CreateTokenResponse>> create(CreateTokenRequest request) {
        return create(request, null);
    }

    public CompletableFuture<PipedreamApiClientHttpResponse<CreateTokenResponse>> create(
        ...
        CompletableFuture<PipedreamApiClientHttpResponse<CreateTokenResponse>> future = new CompletableFuture<>();
    ...
    public CompletableFuture<PipedreamApiClientHttpResponse<ValidateTokenResponse>> validate(String ctok) {
        return validate(ctok, TokensValidateRequest.builder().build());
    }

    public CompletableFuture<PipedreamApiClientHttpResponse<ValidateTokenResponse>> validate(
    ...
    public CompletableFuture<PipedreamApiClientHttpResponse<ValidateTokenResponse>> validate(
        ...
        CompletableFuture<PipedreamApiClientHttpResponse<ValidateTokenResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
