...
public class RawOauthTokensClient {
    ...
    public PipedreamApiClientHttpResponse<CreateOAuthTokenResponse> create(CreateOAuthTokenOpts request) {
        return create(request, null);
    }

    public PipedreamApiClientHttpResponse<CreateOAuthTokenResponse> create(
