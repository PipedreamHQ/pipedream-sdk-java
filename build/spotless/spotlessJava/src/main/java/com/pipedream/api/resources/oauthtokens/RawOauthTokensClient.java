...
public class RawOauthTokensClient {
    ...
    public PipedreamClientHttpResponse<CreateOAuthTokenResponse> create(CreateOAuthTokenOpts request) {
        return create(request, null);
    }

    public PipedreamClientHttpResponse<CreateOAuthTokenResponse> create(
