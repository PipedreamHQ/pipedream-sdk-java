...
public class RawTriggersClient {
    ...
    public PipedreamClientHttpResponse<SyncPagingIterable<Component>> list() {
        return list(TriggersListRequest.builder().build());
    }

    public PipedreamClientHttpResponse<SyncPagingIterable<Component>> list(TriggersListRequest request) {
    ...
    public PipedreamClientHttpResponse<Component> retrieve(String componentId) {
        return retrieve(componentId, null);
    }

    public PipedreamClientHttpResponse<Component> retrieve(String componentId, RequestOptions requestOptions) {
    ...
    public PipedreamClientHttpResponse<ConfigurePropResponse> configureProp(TriggersConfigurePropRequest request) {
        return configureProp(request, null);
    }

    public PipedreamClientHttpResponse<ConfigurePropResponse> configureProp(
    ...
    public PipedreamClientHttpResponse<ReloadPropsResponse> reloadProps(TriggersReloadPropsRequest request) {
        return reloadProps(request, null);
    }

    public PipedreamClientHttpResponse<ReloadPropsResponse> reloadProps(
    ...
    public PipedreamClientHttpResponse<DeployedComponent> deploy(DeployTriggerOpts request) {
        return deploy(request, null);
    }

    public PipedreamClientHttpResponse<DeployedComponent> deploy(
